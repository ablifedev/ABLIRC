...
class _GFFDBCreator(_DBCreator):
    ...
    def _update_relations(self):
        ...
        # ADD by chengchao,add start and end index
        c.execute("DROP INDEX IF EXISTS featureindex")
        c.execute("CREATE INDEX featurestartindex ON features (seqid,featuretype,start,end,strand)")
...
class _GTFDBCreator(_DBCreator):
    ...
    def _update_relations(self):
        ...
        # ADD by chengchao,add start and end index
        c.execute("DROP INDEX IF EXISTS featurestartindex")
        c.execute("CREATE INDEX featurestartindex ON features (start)")

        c.execute("DROP INDEX IF EXISTS featureendindex")
        c.execute("CREATE INDEX featureendindex ON features (end)")
