...
class FeatureDB(object):
    ...
    def features_of_type(self, featuretype, limit=None, strand=None,
                         ...
                         completely_within=False, seqid=None):
        """
    ...
    def all_features(self, limit=None, strand=None, featuretype=None,
                     order_by=None, reverse=False, completely_within=False, seqid=None):
        """
    ...
    def seqids(self):
        """
        Iterate over chromosomes found in the database.

        Returns
        -------
        A generator object that yields chromosomes (as strings)
        """
        c = self.conn.cursor()
        c.execute(
            '''
    ...
    def region(self, region=None, seqid=None, start=None, end=None,
               strand=None, featuretype=None, completely_within=False,order_by=None,reverse=False):
        """
        ...
        order_by : string
            order by this string

        reverse:
            default is ASC, if it is set true ,order by DESC
        ...
        # e.g. "ORDER BY seqid, start DESC"
            ...
            if reverse:
                ...
                direction = 'ASC'
            strand_clause = ' ORDER BY '+order_by+' '+direction
            query += strand_clause
