...
for (i in 1:(len)) {
	data <- read.table(file=file[i],header=T,sep="\t",strip.white = TRUE, comment.char = "" )
...
if (len == 4){
	...
	# lty = "dotted",
	lwd = 1.5,
	fill = c("MediumBlue", "ForestGreen", "GoldenRod", "darkorchid1"),
	alpha = 0.70,
	...
	# cat.dist = c(0.1,0.2,0.3,0.4),
	cat.pos = c(0,30,-30,15),
	cat.cex = 0.8,
	...
	lwd = 4,
	col = "transparent",
	fill = c("MediumBlue", "ForestGreen", "GoldenRod"),
	alpha = 0.5,
